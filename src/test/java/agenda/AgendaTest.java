...
public class AgendaTest {
    ...
    public void testFindByTitle(){
        ...
        ret.add(simple);
        assertEquals(ret, agenda.findByTitle("Simple event"), "Il y a un evenement qui a pour titre Simple event");
    }

    
    @Test
    public void testIsFreeFor(){
        Event simple2 = new Event("Simple event2", LocalDateTime.of(2020, 12, 1, 22, 30), min_120);
        assertTrue(agenda.isFreeFor(simple2));
        Event simple3 = new Event("Simple event3", LocalDateTime.of(2020, 11, 1, 22, 30), min_120);
